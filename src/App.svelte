...
<div class="app">
  <Router>
    ...
    <div class="content">
      ...
      <Route
        path="/gallery/botanica-prelude"
        component={Galleries.GalleryBotanicaPrelude}
      />
      <Route
        path="/gallery/botanica-symphony"
        component={Galleries.GalleryBotanicaSymphony}
      />
      <Route
        path="/gallery/botanica-enigma"
        component={Galleries.GalleryBotanicaEnigma}
      />
      <Route
        path="/gallery/in-the-garden"
        component={Galleries.GalleryInTheGarden}
      />
